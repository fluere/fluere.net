 ...
 */
function(t){"use strict";var e=t(window),n=t("html"),o=t("header.page-header"),i=t("#main-content"),a=n.hasClass("mobile"),r=function(){l(),h(),d(),u(),f(".page-header, .page-footer"),c()},s=function(){i.addClass("is-loading"),window.scrollTo(0,i.offset().top)},c=function(){f("#main-content"),p(),i.find("code[data-gist-id]").length&&window.gistEmbed(),"ga"in window&&window.ga("send","pageview",window.location.pathname+window.location.search),i.filter(".is-loading").removeClass("is-loading").find(".archive__title, .archive__item, .entry__header, .entry__body>*, .entry__comment, .pagination, .return-home").fadeTo(0,0).each(function(e){t(this).stop(!0,!0).delay(100*(e+1)+100).fadeTo(400,1)})},l=function(){e.on("load resize"+(a?"orientationchange scroll":""),function(){o.css("minHeight",e.height()),i.css("minHeight",e.height())}).trigger("resize")},h=function(){var e='a:not([target]):not([href^="#"])';a?t(e).not('[href*="#"]').each(function(){t(this).attr("href",t(this).attr("href")+"#main-content")}):t.pjax({area:"#main-content",link:e,load:{script:!0},callback:c,callbacks:{before:s},scrollTop:!1,scrollLeft:!1})},d=function(){a||n.niceScroll({cursoropacitymax:.4,cursorwidth:7,mousescrollstep:20})},u=function(){var n=t("div.background");n.is(":visible")&&e.on("scroll.swapbg",function(){var t=e.height(),o=e.scrollTop();t>=o?n.css("opacity",Math.max(0,1-o/t)):n.css("opacity",0)}).trigger("scroll.swapbg")},f=function(e){t(e).find("a").filter('[href^="http"]:not([href*="'+location.hostname+'"]):not([target])').attr("target","_blank").end().filter('[href^="#"]:not([href="#"]):not([rel="footnote"])').smoothScroll().end().filter('[rel="footnote"]').smoothScroll({highlight:!0}).end().filter(".popup").popup()},p=function(){var e=location.pathname.split("/");"tag"!==e[1]||e.length<3||(t("title").text(t("title").text().replace(/^archive/,"#"+e[2])),t("h1.archive__title").text("#"+e[2]))};t(document).ready(r),e.on("load",function(){t("html").addClass("is-ready")})}(window.jQuery),/*!
 * @fileOverview Soundtrcks functions.
 */
function(t){"use strict";var e="http://8tracks.com/users/{username}/mixes.jsonp",n="http://8tracks.com/mixes/{id}/player_v3_universal/",o="fluere",i=100,a="c0a25a1aa2e7628c9b2d58ecddcecafe95489012",r=3,s=t("html"),c=t("#soundtracks"),l=c.find(".soundtracks__handle"),h=c.find(".soundtracks__overlay"),d=c.find(".soundtracks__content"),u=c.find(".soundtracks__embeded"),f=c.find(".soundtracks__index"),p=function(){m(),c.on("mousewheel",function(t){t.stopPropagation()}),l.on("click",w),h.hide().on("click",k),d.on("click",function(){return!1})},m=function(){var n=[];t.ajax({type:"GET",url:e.replace("{username}",o),dataType:"jsonp",jsonp:"callback",data:{per_page:i,api_key:a,api_version:r}}).done(function(e){t.each(e.mix_set.mixes,function(){n.push('<li><a href="https://8tracks.com/'+this.web_path+'" target="_blank" data-mixid="'+this.id+'" title="'+this.description+'">'+this.name+'<span class="tracks-count">('+this.tracks_count+'tracks)</span><i class="fa fa-caret-square-o-right"></i></a></li>')}),f.append(n).find("a").on("click",g)}).fail(function(){c.remove()})},g=function(){var e=n.replace("{id}",t(this).data("mixid"));return u.attr("src",e),f.find(".is-current").removeClass("is-current"),t(this).addClass("is-current"),!1},w=function(){h.is(":visible")?k():v()},v=function(){s.addClass("show-overlay"),h.hide().fadeIn(600,"easeOutExpo"),t(document).on("keydown.hideoverlay",function(t){return 27===t.keyCode?(k(),!1):void 0})},k=function(){s.removeClass("show-overlay"),h.fadeOut(600,"easeOutExpo"),t(document).off("keydown.hideoverlay")};t(document).ready(p)}(window.jQuery);